...
<!-- Modal -->
<div class="modal fade" id="addProjectCategory" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addProjectCategoryLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addProjectCategoryLabel">Anda ingin menambah data?</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('project-category.store') }}" method="POST" class="row g-3 needs-validation" novalidate>
                @csrf
                @method('POST')
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped projectCategory">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Name</th>
...
<script>
    $(function() {
        var t = $('.projectCategory').DataTable({
            processing: true,
            serverSide: true,
        ...
        checkPermission('Can add project category', function(hasPermission) {
