...
<div class="modal fade" id="addImageModal" tabindex="-1" aria-labelledby="addImageModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('product.image.store', ['product' => $product->id ]) }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card-body">
                    @foreach($product->images as $item)
                        ...
                        <div class="modal fade" id="setDefaultModal" tabindex="-1" aria-labelledby="setDefaultModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="{{ route('product.image.set_default', ['product' => $product->id, 'image' => $item->id]) }}" method="POST">
                                    @csrf
                        ...
                        <div class="modal fade" id="deleteImageModal" tabindex="-1" aria-labelledby="deleteImageModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="{{ route('product.image.delete', ['product' => $product->id, 'image' => $item->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
