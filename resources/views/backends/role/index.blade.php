...
<style>
    td.details-control {
        background: url('../assets/dashui/images/icon/details_open.png') no-repeat center center;
        cursor: pointer;
    }
    tr.shown td.details-control {
        background: url('../assets/dashui/images/icon/details_close.png') no-repeat center center;
    }
</style>
<div class="row">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="addRoleLabel">Anda ingin menambah data?</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{ route('role.store') }}" method="POST" class="row g-3 needs-validation" novalidate>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped role">
                        <thead>
                            <tr>
                                <th></th>
                                <th>Nama</th>
...
<script>
    $(function() {
        ...
        checkPermission('Can add role', function(hasPermission) {
