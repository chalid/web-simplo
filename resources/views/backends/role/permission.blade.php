        ...
        <div class="card h-100">
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div class="form-check form-switch">
                    <input type="checkbox" data-url="{{ route('role.permission.store',['role'=>$role,'permission'=>$permission]) }}" {!! ($permission->hasRole($role)) ? 'checked':'' !!} name="roleParent" class="form-check-input roleParentChange roleList" id="flexSwitchCheckChecked">
                </div>
            </div>
            <!-- row -->
            <!-- table -->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="text-align:center">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" {!! ($child->hasRole($role)) ? 'checked':'' !!} data-url="{{ route('role.permission.store',['role'=>$role,'permission'=>$child]) }}" name="" class="roleChildrenChange form-check-input" id="flexSwitchCheckChecked">
                                    </div>
                                </td>
                            </tr>
                        </tbody>
