...
<div class="modal fade" id="addImageModal" tabindex="-1" aria-labelledby="addImageModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ route('facility.image.store', ['facility' => $facility->id ]) }}" method="POST" enctype="multipart/form-data">
            @csrf
...
<div class="row">
                ...
                <div class="card-body">
                    @foreach($facility->images as $item)
                        ...
                        <div class="modal fade" id="setDefaultModal" tabindex="-1" aria-labelledby="setDefaultModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="{{ route('facility.image.set_default', ['facility' => $facility->id, 'image' => $item->id]) }}" method="POST">
                                    @csrf
                        ...
                        <div class="modal fade" id="deleteImageModal" tabindex="-1" aria-labelledby="deleteImageModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <form action="{{ route('facility.image.delete', ['facility' => $facility->id, 'image' => $item->id]) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
        ...
        <div class="col-8">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    {{ $facility->title }}
                    <a href="{{ route('facility') }}" class="btn btn-primary btn-sm">
