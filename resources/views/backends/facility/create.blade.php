...
<div class="row">
    <div class="col-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form class="row g-3 needs-validation" method="POST" action="{{ route('facility.store') }}" novalidate enctype="multipart/form-data">
                    @csrf
                    ...
                    <x-form.file name="image" label="facility Picture" />
                    <div class="col-12">
