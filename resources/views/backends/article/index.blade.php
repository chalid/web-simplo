        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped article">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Title</th>
...
<script>
    $(function() {
        ...
        checkPermission('Can add article', function(hasPermission) {
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                ...
                                var routeUrl = '{{ route("article.create") }}';
