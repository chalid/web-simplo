...
<div class="row">
    <div class="col-12">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form class="row g-3 needs-validation" method="POST" action="{{ route('project.store') }}" novalidate enctype="multipart/form-data">
                    @csrf
                    ...
                    <x-form.select name="project_category_id" label="Kategori Project" :options="$projectCategories" :selected="old('project_category_id')" :required="true"/>
                    <x-form.select name="is_active" label="Is Active" :options="[1 => 'Active', 0 => 'In Active']" :selected="old('is_active')" :required="true"/>
                    <x-form.file name="image" label="Project Picture" />
                    <div class="col-12">
