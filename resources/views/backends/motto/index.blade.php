        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped motto">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Title</th>
...
<script>
    $(function() {
        ...
        checkPermission('Can add motto', function(hasPermission) {
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                ...
                                var routeUrl = '{{ route("motto.create") }}';
