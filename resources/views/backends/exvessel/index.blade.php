        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped exvessel">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Title</th>
    ...
    $(function() {
        var t = $('.exvessel').DataTable({
            ...
            columns: [
                ...
                {data: 'is_sold', name: 'is_sold', orderable:true, searchable: false},
                {data: 'is_active', name: 'is_active', orderable:true, searchable: false},
                {data: 'vessel_type_label'},
        ...
        checkPermission('Can add exvessel', function(hasPermission) {
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                ...
                                var routeUrl = '{{ route("exvessel.create") }}';
