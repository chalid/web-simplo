        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped client">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Name</th>
...
<script>
    $(function() {
        ...
        checkPermission('Can add client', function(hasPermission) {
                    ...
                    buttons: [
                        {
                            ...
                            action: function (e, dt, node, config) {
                                ...
                                var routeUrl = '{{ route("client.create") }}';
