                    ...
                    <table class="table mb-0 text-nowrap table-centered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>/ <a href="#!" class="text-inherit"><i data-feather="external-link" class="icon-xs"></i></a></td>
                          <td class="text-end">
                            <div>
                        ...
                        <tr>
                          ...
                          <td>/landings/courses.html <a href="#!" class="text-inherit"><i data-feather="external-link" class="icon-xs"></i></a>
                          </td>
                          <td class="text-end">
                            <div>
                        ...
                        <tr>
                          ...
                          <td>/landings/lead.html <a href="#!" class="text-inherit"><i data-feather="external-link" class="icon-xs"></i></a>
                          </td>
                          <td class="text-end">
                            <div>
                        ...
                        <tr>
                          ...
                          <td>/dashboard.html <a href="#!" class="text-inherit"><i data-feather="external-link" class="icon-xs"></i></a></td>
                          <td class="text-end">
                            <div>
                        ...
                        <tr>
                          ...
                          <td>/checkout.html <a href="#!" class="text-inherit"><i data-feather="external-link" class="icon-xs"></i></a></td>
                          <td class="text-end">
                            <div>
                          ...
                          <td class="ps-0">
                            <div class="progress rounded-0 " style="height: 8px;">
                              <div class="progress-bar" role="progressbar" aria-label="Basic example" style="width: 28%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td class="ps-0">
                            <div class="progress rounded-0 " style="height: 8px;">
                              <div class="progress-bar" role="progressbar" aria-label="Basic example" style="width: 18%" aria-valuenow="18" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </td>
                        </tr>
                      </tbody>
                    ...
                    <table class="table mb-0 text-nowrap table-centered">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="ps-0">
                            <div class="progress" style="height: 4px;">
                              <div class="progress-bar bg-info" role="progressbar" aria-label="Basic example" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="ps-0">
                            <div class="progress" style="height: 4px;">
                              <div class="progress-bar bg-success" role="progressbar" aria-label="Basic example" style="width: 54%" aria-valuenow="54" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="ps-0">
                            <div class="progress" style="height: 4px;">
                              <div class="progress-bar" role="progressbar" aria-label="Basic example" style="width: 64%" aria-valuenow="64" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="ps-0">
                            <div class="progress" style="height: 4px;">
                              <div class="progress-bar bg-warning" role="progressbar" aria-label="Basic example" style="width: 34%" aria-valuenow="34" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="ps-0">
                            <div class="progress" style="height: 4px;">
                              <div class="progress-bar bg-info" role="progressbar" aria-label="Basic example" style="width: 23%" aria-valuenow="23" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td class="ps-0">
                            <div class="progress" style="height: 4px;">
                              <div class="progress-bar bg-danger" role="progressbar" aria-label="Basic example" style="width: 14%" aria-valuenow="14" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </td>
              ...
              <div class="card h-100">
                ...
                <div class="card-body p-0">
                  ...
                  <table class="table mb-0">
                    <tbody>
                      <tr>
                        <td class="border-top-0 "> <img src="../assets/images/svg/browser-svg/chrome.svg" alt="Image" class="me-2"><span>Google
                            Chrome</span></td>
                      ...
                      <tr>
                        <td> <img src="../assets/images/svg/browser-svg/opera.svg" alt="Image" class="me-2"><span>Opera
                            Mini</span></td>
                        <td class="text-end  ">8%</td>

                      </tr>
                      <tr>
                        <td> <img src="../assets/images/svg/browser-svg/microsoft-edge.svg" alt="Image" class="me-2"><span>Microsoft edge</span></td>
